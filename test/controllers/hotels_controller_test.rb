...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { Attraction: @hotel.Attraction, Car: @hotel.Car, Guide: @hotel.Guide } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { Attraction: @hotel.Attraction, Car: @hotel.Car, Guide: @hotel.Guide } }
